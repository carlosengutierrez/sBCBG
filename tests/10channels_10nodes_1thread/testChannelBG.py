...
def checkAvgFR(showRasters=False,params={},antagInjectionSite='none',antag='',logFileName=''):
  nest.ResetKernel()
  dataPath='log/'
  print 'checking nbcpu, threads : ',params['nbcpu']
  #nest.SetKernelStatus({'local_num_threads': params['nbcpu'] if ('nbcpu' in params) else 2, "data_path": dataPath})
  nest.SetKernelStatus({'local_num_threads':params['nbcpu'],'data_path':dataPath})
  initNeurons()
  ...
  print "end of simulation ... (s)",time.time()-start_time
  score = 0
